import { getFilesystemBackendInfo } from '@devalbo-cli/filesystem';
import type { AsyncCommandHandler } from '@devalbo-cli/cli-shell/commands/_util';
import { makeError, makeOutput } from '@devalbo-cli/cli-shell/commands/_util';

export const systemCommandsBrowser: Record<'clear' | 'backend' | 'exit' | 'help', AsyncCommandHandler> = {
